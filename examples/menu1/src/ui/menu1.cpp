...
// TEXT
std::shared_ptr<Text_Box>     Test_Menu::text                 { nullptr };
...
const std::shared_ptr<Menu> Test_Menu::construct(std::shared_ptr<Graphics_Context> context, std::shared_ptr<Event_Handler> handler) {
    ...
    button_layout->placeUI_Element(std::make_shared<Text_Box>(context, "Ping Server", font, 15, font_color, ALIGN_X::CENTER, ALIGN_Y::CENTER), 0);
    ...
    // pannel_layout->placeUI_Element(new Text_Box(context, "Short Text", font, 15, font_color, ALIGN_X::CENTER, ALIGN_Y::CENTER), 0);
    // pannel_layout->placeUI_Element(new Text_Box(context, medium, font, 15, font_color, ALIGN_X::CENTER, ALIGN_Y::CENTER), 1);
    ...
    input_button_layout->placeUI_Element(std::make_shared<Text_Box>(context, "Submit username:", font, 15, font_color), 0);
    ...
    text = std::make_shared<Text_Box>(context, "Enter a username to join a random session...", font, 15, font_color, ALIGN_X::CENTER, ALIGN_Y::CENTER);
